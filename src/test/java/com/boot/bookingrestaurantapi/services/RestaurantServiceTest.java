...
public class RestaurantServiceTest {
    ...
    private static final String DESCRIPTION = "Todos tipo de hamburguesa";
    ...
    public void getRestaurantsByIdTestError() throws BookingException{
        Mockito.when(restaurantRepository.findById(RESTAURANT_ID))
    ...
    public void getRestaurants() throws  BookingException{
        ...
        List<RestaurantRest> response = restaurantService.getRestaurants();
