...
public class ReservationServiceTest {
    ...
    @Test
    public void createReservationServiceTest() throws BookingException {
        Mockito.when(restaurantRepository.findById(RESTAURANT_ID))
                .thenReturn(OPTIONAL_RESTAURANT);
        Mockito.when(turnRepository.findById(TURN_ID))
                .thenReturn(OPTIONAL_TURN);
    ...
    public void createReservationTurnFindByIdTestError() throws BookingException {
        ...
        Mockito.when(turnRepository.findById(TURN_ID))
                .thenReturn(OPTIONAL_TURN_EMPTY);
